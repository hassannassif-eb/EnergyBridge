...
function useMediaQueryNew(query, defaultMatches, matchMedia, ssrMatchMedia, noSsr) {
  ...
  const [getSnapshot, subscribe2] = React6.useMemo(() => {
    if (matchMedia === null) {
      return [getDefaultSnapshot, () => () => {
      }];
    }
...
function unstable_createUseMediaQuery(params = {}) {
  ...
  return function useMediaQuery2(queryInput, options = {}) {
    ...
    const matchMedia = React6.useMemo(() => {
  ...
  const Grid2 = React19.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime13.jsx)(GridRoot, {
      ...
      children: React19.Children.map(children, (child) => {
        var _a;
        if (React19.isValidElement(child) && isMuiElement(child, ["Grid"]) && container2 && child.props.container) {
...
@mui/system/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-MYRQQOII.js.map
