import {
  ...
  useFormControl,
  useFormControlState
} from "./chunk-OGUWCGI7.js";
import {
  createSvgIcon
} from "./chunk-6PNMJVB4.js";
import {
  capitalize_default,
...
import {
  ...
  useRtl,
  useTheme
} from "./chunk-ZV4LYL4D.js";
import {
  css,
  keyframes
} from "./chunk-66BKDLGG.js";
import {
  require_react_dom
...
function useAutocomplete(props) {
  ...
  const ignoreNextBackspaceRef = React3.useRef(false);
  const windowLostFocus = React3.useRef(false);
  const [anchorEl, setAnchorEl] = React3.useState(null);
  const [focusedItem, setFocusedItem] = React3.useState(-1);
  const defaultHighlighted = autoHighlight ? 0 : -1;
  const highlightedIndexRef = React3.useRef(defaultHighlighted);
  const highlightReasonRef = React3.useRef(null);
  const touchScrolledRef = React3.useRef(false);
  const isTouchRef = React3.useRef(false);
  ...
  return {
    ...
    getListboxProps: (other = {}) => ({
      ...
      onMouseDown: (event) => {
        var _a;
        (_a = other.onMouseDown) == null ? void 0 : _a.call(other, event);
        if (event.defaultMuiPrevented) {
          return;
        }
        event.preventDefault();
      ...
      onScroll: (event) => {
        var _a;
        (_a = other.onScroll) == null ? void 0 : _a.call(other, event);
        if (event.defaultMuiPrevented) {
          return;
        }
        if (isTouchRef.current) {
      ...
      onMouseLeave: (event) => {
        var _a;
        (_a = other.onMouseLeave) == null ? void 0 : _a.call(other, event);
        if (event.defaultMuiPrevented) {
          return;
        }
...
var PopperTooltip = React6.forwardRef(function PopperTooltip2(props, forwardedRef) {
  ...
  const resolvedAnchorElement = React6.useMemo(() => resolveAnchorEl(anchorEl), [anchorEl]);
  React6.useEffect(() => {
...
function useButtonBase(parameters) {
  ...
  const hasNativeKeyboardActivation = React12.useCallback(() => {
    const root = rootRef.current;
    if (root == null) {
      return nativeButton;
    }
  ...
  const getButtonProps = React12.useCallback((externalProps = EMPTY2) => {
    const {
...
function Ripple(props) {
  ...
  const exitTimerStartedRef = React15.useRef(false);
  const onExitedRef = React15.useRef(onExited);
...
function useReducedMotionMediaQueryOld(enabled) {
  const [queryState, setQueryState] = React16.useState(() => ({
    enabled,
...
var TouchRipple = React17.forwardRef(function TouchRipple2(inProps, ref) {
  ...
  const [rippleState, setRippleState] = React17.useState({
    items: EMPTY_ARRAY,
    order: EMPTY_ARRAY
  });
  ...
  const mountedRef = React17.useRef(false);
  useOnMount(() => {
  ...
  const start2 = useEventCallback_default2((event = EMPTY_OBJ, options = EMPTY_OBJ, cb = NOOP2) => {
    const {
  ...
  return (0, import_jsx_runtime6.jsx)(TouchRippleRoot, {
    ...
    ref: container,
    ...other,
    children: orderedRipples.map((ripple) => (0, import_jsx_runtime6.jsx)(TouchRippleRipple, {
      classes: {
...
var ButtonBase = React18.forwardRef(function ButtonBase2(inProps, ref) {
  ...
  return (0, import_jsx_runtime7.jsxs)(ButtonBaseRoot, {
    ...
    ...other,
    children: [children, enableTouchRipple ? (0, import_jsx_runtime7.jsx)(TouchRipple_default, {
      ref: handleRippleRef,
      center: centerRipple,
      ...TouchRippleProps
    }) : null]
...
true ? ButtonBase.propTypes = {
   ...
   * @ignore
   */
  formAction: import_prop_types8.default.oneOfType([import_prop_types8.default.func, import_prop_types8.default.string]),
  /**
   * @ignore
   */
   ...
   */
  nativeButton: import_prop_types8.default.bool,
  /**
   * @ignore
   */
...
var CircularProgressCircle = styled_default("circle", {
  ...
  overridesResolver: (props, styles4) => {
    ...
    return [styles4.circle, ownerState.disableShrink && styles4.circleDisableShrink];
  }
})(memoTheme_default(({
  theme
}) => {
...
var CircularProgress = React19.forwardRef(function CircularProgress2(inProps, ref) {
  ...
  if (variant === "determinate") {
    ...
    if (true) {
      if (!warnedInvalidMinMaxValue && (value < min2 || value > max2 || min2 >= max2)) {
...
true ? CircularProgress.propTypes = {
   ...
   * @default false
   */
  enableTrackSlot: import_prop_types9.default.bool,
  /**
...
var ChipRoot = styled_default("div", {
  ...
  overridesResolver: (props, styles4) => {
    ...
    }, styles4.root, styles4[`size${capitalize_default(size)}`], styles4[`color${capitalize_default(color)}`], clickable && styles4.clickable, onDelete && styles4.deletable, styles4[variant]];
  }
})(memoTheme_default(({
  theme
}) => {
...
var Autocomplete = React23.forwardRef(function Autocomplete2(inProps, ref) {
  ...
  const previousGroupedOptionsRef = React23.useRef([]);
  const prevPopupOpenRef = React23.useRef(false);
  ...
  return (0, import_jsx_runtime14.jsxs)(React23.Fragment, {
          ...
          input: {
            ...
            ...(hasClearIcon || hasPopupIcon) && {
              endAdornment: (0, import_jsx_runtime14.jsxs)(AutocompleteEndAdornment, {
                ...
                ownerState,
                children: [hasClearIcon ? (0, import_jsx_runtime14.jsx)(ClearIndicatorSlot, {
                  ...clearIndicatorProps,
                  children: clearIcon
                }) : null, hasPopupIcon ? (0, import_jsx_runtime14.jsx)(PopupIndicatorSlot, {
                  ...popupIndicatorProps,
                  children: popupIcon
                }) : null]
              })
    ...
    }), anchorEl && hasPopupContent ? (0, import_jsx_runtime14.jsx)(AutocompletePopper, {
      as: PopperSlot,
      ...popperProps,
      children: (0, import_jsx_runtime14.jsxs)(AutocompletePaper, {
        as: PaperSlot,
        ...paperProps,
        children: [loading && renderedOptions.length === 0 ? (0, import_jsx_runtime14.jsx)(AutocompleteLoading, {
          className: classes.loading,
          ownerState,
          children: loadingText
        }) : null, renderedOptions.length === 0 && !freeSolo && !loading ? (0, import_jsx_runtime14.jsx)(AutocompleteNoOptions, {
        ...
        }) : null, renderedOptions.length > 0 ? (0, import_jsx_runtime14.jsx)(ListboxSlot, {
          ...listboxProps,
...
true ? Autocomplete.propTypes = {
   ...
   * @default false
   */
  resetHighlightOnMouseLeave: import_prop_types12.default.bool,
  /**
...
var SwitchBase = React25.forwardRef(function SwitchBase2(props, ref) {
  ...
  return (0, import_jsx_runtime16.jsxs)(RootSlot, {
    ...rootSlotProps,
    children: [(0, import_jsx_runtime16.jsx)(InputSlot, {
      ...inputSlotProps
...
function FocusTrap(props) {
  ...
  React28.useEffect(() => {
    ...
    const loopFocus = (nativeEvent) => {
      ...
      const isFocusStart = activeElement2 === rootElement || activeElement2 === focusTarget;
      if (isFocusStart) {
      ...
      if (contains_default(rootElement, activeElement2)) {
        const tabbable = getTabbable(rootElement);
        const currentIndex = tabbable.indexOf(activeElement2);
        if (currentIndex === -1) {
          return;
        }
...
var EMPTY_STYLE = {};
var warnedMinMaxWithoutVariant2 = false;
var warnedInvalidMinMaxValue2 = false;
...
var LinearProgressBar1 = styled_default("span", {
  ...
  slot: "Bar1",
  overridesResolver: (props, styles4) => {
    return [styles4.bar, styles4.bar1];
  }
})(memoTheme_default(({
  theme
}) => {
...
var LinearProgressBar2 = styled_default("span", {
  ...
  slot: "Bar2",
  overridesResolver: (props, styles4) => {
    return [styles4.bar, styles4.bar2];
  }
})(memoTheme_default(({
  theme
}) => {
...
var LinearProgress = React29.forwardRef(function LinearProgress2(inProps, ref) {
  ...
  if (true) {
    if (!warnedMinMaxWithoutVariant2 && ["indeterminate", "query"].includes(variant) && (minProp !== void 0 || maxProp !== void 0)) {
      ...
      warnedMinMaxWithoutVariant2 = true;
    }
  }
  const min2 = minProp ?? 0;
  const max2 = maxProp ?? 100;
  ...
  if (variant === "determinate" || variant === "buffer") {
    if (value !== void 0) {
      if (true) {
        if (!warnedInvalidMinMaxValue2 && (value < min2 || value > max2 || min2 >= max2)) {
          ...
          warnedInvalidMinMaxValue2 = true;
        }
      }
      const range = max2 - min2;
  ...
  if (variant === "buffer") {
    if (valueBuffer !== void 0) {
      if (true) {
        if (!warnedInvalidMinMaxValueBuffer && (valueBuffer < min2 || valueBuffer > max2 || valueBuffer < value || min2 >= max2)) {
...
var TypographyRoot = styled_default("span", {
  ...
  overridesResolver: (props, styles4) => {
    ...
    return [styles4.root, ownerState.variant && styles4[ownerState.variant], ownerState.align !== "inherit" && styles4[`align${capitalize_default(ownerState.align)}`], ownerState.noWrap && styles4.noWrap, ownerState.gutterBottom && styles4.gutterBottom];
  }
})(memoTheme_default(({
  theme
}) => {
...
var SelectFocusSourceContext = React35.createContext(null);
if (true) {
  SelectFocusSourceContext.displayName = "SelectFocusSourceContext";
}
function useSelectFocusSource() {
  const context = React35.useContext(SelectFocusSourceContext);
  return context;
}
...
var RovingTabIndexContext = React36.createContext(void 0);
if (true) {
  RovingTabIndexContext.displayName = "RovingTabIndexContext";
}
function useRovingTabIndexContext() {
  const context = React36.useContext(RovingTabIndexContext);
  if (context === void 0) {
...
function useRovingTabIndexRoot(params) {
  ...
  const [activeItemIdState, setActiveItemIdState] = React37.useState(activeItemIdProp);
  const [previousActiveItemIdProp, setPreviousActiveItemIdProp] = React37.useState(activeItemIdProp);
  ...
  const itemMapRef = React37.useRef(/* @__PURE__ */ new Map());
  const [mapTick, setMapTick] = React37.useState(0);
  const orderedItems = React37.useMemo(() => {
  ...
  const activeItemIdRef = React37.useRef(resolvedActiveItemId);
  activeItemIdRef.current = resolvedActiveItemId;
  const getActiveItem = React37.useCallback(() => {
  ...
  const getItemMap = React37.useCallback(() => {
  ...
  const isItemActive = React37.useCallback((itemId) => {
    return activeItemIdRef.current === itemId;
  }, []);
  const focusItem = React37.useCallback((currentIndex, direction, wrap2, isItemFocusableOverride) => {
    var _a;
  ...
  const getContainerProps = React37.useCallback((ref) => {
    const onFocus = (event) => {
      const snapshot = getNavigableItemsSnapshot(itemMapRef.current);
  ...
  const focusNext = React37.useCallback((isItemFocusableOverride) => {
    var _a;
    const snapshot = getNavigableItemsSnapshot(itemMapRef.current);
    const currentFocus = activeElement(ownerDocument(containerRef.current));
    const isFocusOnContainer = currentFocus === containerRef.current;
...
function useRovingTabIndexItem(params) {
  ...
  const latestItemRef = React37.useRef(item);
  latestItemRef.current = item;
  const handleElementRef = React37.useCallback((element) => {
...
var MenuListContext = React38.createContext(void 0);
if (true) {
  MenuListContext.displayName = "MenuListContext";
}
function useMenuListContext() {
  const context = React38.useContext(MenuListContext);
  if (context === void 0) {
...
var MenuList = React39.forwardRef(function MenuList2(props, ref) {
  ...
  const hasFocusedInitialTargetRef = React39.useRef(false);
  const [suppressInitialFocusVisible, setSuppressInitialFocusVisible] = React39.useState(false);
  ...
  const getDefaultActiveItemId = React39.useCallback((items) => {
    var _a, _b, _c;
  ...
  const menuListContextValue = React39.useMemo(() => ({
  ...
  return (0, import_jsx_runtime28.jsx)(List_default, {
    ...
    tabIndex: -1,
    ...other,
    children: (0, import_jsx_runtime28.jsx)(MenuListContext.Provider, {
      value: menuListContextValue,
      children: (0, import_jsx_runtime28.jsx)(RovingTabIndexContext.Provider, {
...
function Transition(props) {
  ...
  const parentGroup = React42.useContext(TransitionGroupContext_default);
  const shouldEnterOnMount = parentGroup && !parentGroup.isMounting ? enter : appear;
  const [status, setStatus] = React42.useState(() => {
    if (inProp) {
  ...
  const statusRef = React42.useRef(status);
  statusRef.current = status;
  if (inProp && status === "unmounted") {
    statusRef.current = "exited";
    setStatus("exited");
  }
  const shouldAppearOnMountRef = React42.useRef(inProp && shouldEnterOnMount);
  const mountedRef = React42.useRef(false);
  const nextCallbackRef = React42.useRef(null);
  const lastFiredStatusRef = React42.useRef(status);
  const isAppearingRef = React42.useRef(false);
  const transitionReduceMotionRef = React42.useRef(reduceMotion);
  ...
  const cancelPendingCallback = React42.useCallback(() => {
    if (nextCallbackRef.current !== null) {
      nextCallbackRef.current.cancel();
      nextCallbackRef.current = null;
    }
  }, []);
  const makeCallback = React42.useCallback((handler) => {
    let active = true;
    const wrapped = () => {
      if (active) {
        active = false;
  ...
  const scheduleTransitionEnd = React42.useCallback((nextStatus, currentStatus) => {
    var _a, _b;
    let timeoutId;
    const clearTimer = () => {
      if (timeoutId !== void 0) {
  ...
  const performEnter = React42.useCallback((mounting) => {
    var _a;
  ...
  const performExit = React42.useCallback(() => {
    var _a;
    const current = propsRef.current;
    if (!current.exit) {
      statusRef.current = "exited";
  ...
  const updateStatus = React42.useCallback((mounting, nextStatus) => {
  ...
  return (0, import_jsx_runtime30.jsx)(TransitionGroupContext_default.Provider, {
    value: null,
...
true ? Transition.propTypes = {
   ...
   * @ignore
   */
  getAutoTimeout: import_prop_types26.default.func,
  /**
   * @ignore
   */
   ...
   * @ignore
   */
  reduceMotion: import_prop_types26.default.bool,
  /**
   * @ignore
   */
...
var Fade = React43.forwardRef(function Fade2(props, ref) {
  ...
  return (0, import_jsx_runtime31.jsx)(Transition_default, {
    appear,
    in: inProp,
    nodeRef,
    onEnter: handleEnter,
...
true ? Fade.propTypes = {
   ...
   * @default false
   */
  disablePrefersReducedMotion: import_prop_types27.default.bool,
  /**
...
var Modal = React46.forwardRef(function Modal2(inProps, ref) {
  ...
  return (0, import_jsx_runtime33.jsx)(Portal_default, {
    ...
    children: (0, import_jsx_runtime33.jsxs)(RootSlot, {
      ...rootProps,
      children: [!hideBackdrop ? (0, import_jsx_runtime33.jsx)(BackdropSlot, {
        ...backdropProps
...
var OutlinedInput = React49.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  const [NotchedSlot, notchedProps] = useSlot("notchedOutline", {
    ...
    additionalProps: {
      label: label != null && label !== "" && fcs.required ? (0, import_jsx_runtime37.jsxs)(React49.Fragment, {
        children: [label, " ", "*"]
      }) : label
    }
  });
...
var Grow = React54.forwardRef(function Grow2(props, ref) {
  ...
  const autoTimeout = React54.useRef(null);
  const theme = useTheme();
  const reducedMotion = useReducedMotion(theme.motion.reducedMotion, disablePrefersReducedMotion);
  ...
  return (0, import_jsx_runtime42.jsx)(Transition_default, {
    appear,
    in: inProp,
    nodeRef,
    onEnter: handleEnter,
...
true ? Grow.propTypes = {
   ...
   * @default false
   */
  disablePrefersReducedMotion: import_prop_types38.default.bool,
  /**
   * The transition timing function.
   * You may specify a single easing or a object containing enter and exit values.
   */
...
var NativeSelectInput = React57.forwardRef(function NativeSelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime45.jsxs)(React57.Fragment, {
...
function getTextFromReactNode(node) {
  ...
  let text = "";
  React58.Children.forEach(node, (child) => {
...
function getTypeaheadOptions(childrenArray, value) {
  ...
  for (let index = 0; index < childrenArray.length; index += 1) {
    ...
    if (!React58.isValidElement(child) || !hasOwnValueProp(child) || child.props.disabled) {
      continue;
    }
...
var SelectIcon = styled_default(StyledSelectIcon, {
  ...
  overridesResolver: (props, styles4) => {
    ...
    return [styles4.icon, ownerState.open && styles4.iconOpen];
  }
})({});
...
var SelectInput = React59.forwardRef(function SelectInput2(props, ref) {
  ...
  const openRef = React59.useRef(false);
  const hasSelectedItemInListRef = React59.useRef(false);
  const openingMouseUpListenerCleanupRef = React59.useRef(null);
  const didPointerDownOnItemRef = React59.useRef(false);
  const selectionRef = React59.useRef({
    allowSelectedMouseUp: false,
    allowUnselectedMouseUp: false
  });
  const closedTypeaheadRef = React59.useRef({
    buffer: "",
  ...
  const [openInteractionType, setOpenInteractionType] = React59.useState(null);
  ...
  const resetClosedTypeahead = React59.useCallback(() => {
  ...
  const clearOpeningMouseUpListener = React59.useCallback(() => {
  ...
  const handleClosedTypeahead = (event) => {
    ...
    if (open || multiple || disabled || event.defaultPrevented || ((_a2 = event.nativeEvent) == null ? void 0 : _a2.isComposing) || event.key.length !== 1 || event.ctrlKey || event.metaKey || event.altKey || event.key === SPACE && !hasActiveBuffer) {
      return false;
    }
    if (event.key === SPACE) {
      event.preventDefault();
  ...
  const handleItemKeyDown = (child) => (event) => {
    var _a2, _b2;
    (_b2 = (_a2 = child == null ? void 0 : child.props) == null ? void 0 : _a2.onKeyDown) == null ? void 0 : _b2.call(_a2, event);
  ...
  return (0, import_jsx_runtime46.jsxs)(React59.Fragment, {
    children: [(0, import_jsx_runtime46.jsx)(SelectSelect, {
      ...
      className: classes.icon,
      ownerState
    }), (0, import_jsx_runtime46.jsx)(SelectFocusSourceProvider, {
      value: openInteractionType,
      children: (0, import_jsx_runtime46.jsx)(Menu_default, {
        id: `menu-${name || ""}`,
...
var Select = React60.forwardRef(function Select2(inProps, ref) {
  ...
  return (0, import_jsx_runtime47.jsx)(React60.Fragment, {
...
var FormControlLabel = React62.forwardRef(function FormControlLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime49.jsxs)(FormControlLabelRoot, {
    ...
    ref,
    ...other,
    children: [React62.cloneElement(control, controlProps), required ? (0, import_jsx_runtime49.jsxs)("div", {
      children: [label, (0, import_jsx_runtime49.jsxs)(AsteriskComponent2, {
        ownerState,
        "aria-hidden": true,
        className: classes.asterisk,
        children: [" ", "*"]
...
var ButtonRoot = styled_default(ButtonBase_default, {
  ...
  overridesResolver: (props, styles4) => {
    ...
    return [styles4.root, styles4[ownerState.variant], styles4[`size${capitalize_default(ownerState.size)}`], ownerState.color === "inherit" && styles4.colorInherit, ownerState.disableElevation && styles4.disableElevation, ownerState.fullWidth && styles4.fullWidth, ownerState.loading && styles4.loading];
  }
})(memoTheme_default(({
  theme
}) => {
...
var ButtonStartIcon = styled_default("span", {
  ...
  overridesResolver: (props, styles4) => {
    ...
    return [styles4.startIcon, ownerState.loading && styles4.startIconLoadingStart];
  }
})(({
  theme
}) => ({
...
var ButtonEndIcon = styled_default("span", {
  ...
  overridesResolver: (props, styles4) => {
    ...
    return [styles4.endIcon, ownerState.loading && styles4.endIconLoadingEnd];
  }
})(({
  theme
}) => ({
...
var Button = React66.forwardRef(function Button2(inProps, ref) {
  ...
  const startIcon = (startIconProp || loading && loadingPosition === "start") && (0, import_jsx_runtime51.jsx)(ButtonStartIcon, {
    className: classes.startIcon,
    ownerState,
    children: startIconProp || (0, import_jsx_runtime51.jsx)(ButtonLoadingIconPlaceholder, {
      className: classes.loadingIconPlaceholder,
      ownerState
    })
  });
  const endIcon = (endIconProp || loading && loadingPosition === "end") && (0, import_jsx_runtime51.jsx)(ButtonEndIcon, {
    className: classes.endIcon,
    ownerState,
    children: endIconProp || (0, import_jsx_runtime51.jsx)(ButtonLoadingIconPlaceholder, {
      className: classes.loadingIconPlaceholder,
      ownerState
    })
  });
  ...
  const loader = typeof loading === "boolean" ? (
    ...
    (0, import_jsx_runtime51.jsx)("span", {
      ...
      children: loading && (0, import_jsx_runtime51.jsx)(ButtonLoadingIndicator, {
        className: classes.loadingIndicator,
        ownerState,
  ...
  return (0, import_jsx_runtime51.jsxs)(ButtonRoot, {
    ownerState,
...
var Tooltip = React68.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const children = React68.isValidElement(childrenProp) ? childrenProp : (0, import_jsx_runtime53.jsx)("span", {
    children: childrenProp
  });
  const theme = useTheme();
  ...
  return (0, import_jsx_runtime53.jsxs)(React68.Fragment, {
    children: [React68.cloneElement(children, childrenProps), (0, import_jsx_runtime53.jsx)(PopperSlot, {
      as: Popper_default,
      placement,
...
true ? ClickAwayListener.propTypes = {
   ...
   */
  onClickAway: import_prop_types54.default.func.isRequired,
  /**
...
var TabScrollButton = React77.forwardRef(function TabScrollButton2(inProps, ref) {
  ...
  return (0, import_jsx_runtime63.jsx)(TabScrollButtonRoot, {
    component: "div",
    className: clsx_default(classes.root, className),
    ref,
    role: null,
    ...
    children: direction === "left" ? (0, import_jsx_runtime63.jsx)(StartButtonIcon, {
      ...startButtonIconProps
    }) : (0, import_jsx_runtime63.jsx)(EndButtonIcon, {
      ...endButtonIconProps
    })
  });
});
...
var List3 = styled_default("div", {
  ...
  overridesResolver: (props, styles4) => {
    ...
    return [styles4.list, ownerState.centered && styles4.centered];
  }
})({
  display: "flex",
  variants: [{
...
var Tabs = React79.forwardRef(function Tabs2(inProps, ref) {
  ...
  const [isFocusWithinList, setIsFocusWithinList] = React79.useState(false);
  ...
  const validChildren = React79.Children.toArray(childrenProp).filter(React79.isValidElement).map((child, index) => {
  ...
  return (0, import_jsx_runtime65.jsxs)(RootSlot, {
    ...
    children: [conditionalElements.scrollButtonStart, conditionalElements.scrollbarSizeListener, (0, import_jsx_runtime65.jsxs)(ScrollerSlot, {
      ...
      children: [(0, import_jsx_runtime65.jsx)(ListSlot, {
        ...
        role: "tablist",
        ...listSlotProps,
        children: (0, import_jsx_runtime65.jsx)(RovingTabIndexContext.Provider, {
          value: rovingContainer,
          children
        })
      }), mounted && indicator]
...
var Tab = React80.forwardRef(function Tab2(inProps, ref) {
  ...
  return (0, import_jsx_runtime66.jsxs)(TabRoot, {
    internalNativeButton: true,
    focusRipple: !disableFocusRipple,
    className: clsx_default(classes.root, className),
    ...
    ownerState,
    ...other,
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime66.jsxs)(React80.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime66.jsxs)(React80.Fragment, {
      children: [label, icon]
    }), indicator]
  });
});
...
//# sourceMappingURL=chunk-TJQA2JOT.js.map
